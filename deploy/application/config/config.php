...
$protocol = GLOBAL_USE_HTTPS ? 'https://' : 'http://';
...
$config['sess_expiration'] = 28800; // 4 hours
...
$config['cookie_path']		= '/';
$config['cookie_secure'] = (ENVIRONMENT !== ENV_DEVELOPMENT);
...
$config['csrf_cookie_name'] = 'csrf_api_c';
